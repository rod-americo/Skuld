...
class EntrypointTest(unittest.TestCase):
    def test_script_reuses_importable_entrypoint(self) -> None:
        module = load_entrypoint_module()
        self.assertIs(module.main, skuld_entrypoint.main)
        self.assertIs(module.select_backend_module, skuld_entrypoint.select_backend_module)
